...
expName = 'DotsGame_22Nov19'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\local-admin\\Desktop\\Dense sampling\\SimultNonsymNumberComparison_BehVers\\DotsGame_v09302020.py',
...
gameExample = visual.ImageStim(
    ...
    image='DotsGame_images/instruction_example_dots.png', mask=None,
    ori=0, pos=(0, 0), size=(0.6457, 0.5),
...
hand_left = visual.ImageStim(
    ...
    image='DotsGame_images/hand_left.png', mask=None,
...
button_yellow = visual.ImageStim(
    ...
    image='DotsGame_images/black_button.png', mask=None,
...
hand_right = visual.ImageStim(
    ...
    image='DotsGame_images/hand_right.png', mask=None,
    ori=0, pos=(.4, -.2), size=(.188, .3),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
check_mark = visual.ImageStim(
    ...
    image='DotsGame_images/check_mark.png', mask=None,
...
prepracLeft1 = visual.ImageStim(
    ...
    image='DotsGame_images/3_437_1.bmp', mask=None,
    ori=0, pos=(-.28, 0), size=(.37, .37),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
prepracRight1 = visual.ImageStim(
    ...
    image='DotsGame_images/3_438_2.bmp', mask=None,
    ori=0, pos=(.28, 0), size=(.37, .37),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-2.0)
prepracInstruct1 = visual.TextStim(win=win, name='prepracInstruct1',
    text='Which side has more? \nWhich button would you press?',
    font='Arial',
...
prepracLeft2 = visual.ImageStim(
    ...
    image='DotsGame_images/1_145_1.bmp', mask=None,
    ori=0, pos=(-.28, 0), size=(.37, .37),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
prepracRight2 = visual.ImageStim(
    ...
    image='DotsGame_images/1_146_2.bmp', mask=None,
    ori=0, pos=(.28, 0), size=(.37, .37),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-2.0)
...
trials_Prac = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('conds/DotsGame_Prac.xlsx', selection='0:10'),
...
for thisTrials_Prac in trials_Prac:
    ...
    if pracResp.keys: # if the list isn't empty (i.e., a button was pressed) 
        if pracResp.corr:
            feedbackMsg = "Correct!"
            feedbackImg = "DotsGame_images/check_mark.png"
        elif pracResp.corr == 0:
            feedbackMsg = "Wrong..."
            feedbackImg = "DotsGame_images/x_mark.png"
    else:
...
trials_Test1 = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('conds/DotsGame_Block1.xlsx'),
...
trials_Test2 = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('conds/DotsGame_Block2.xlsx'),
